...
class ask_propio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ask_propio")
        ...
        self.qtgui_const_sink_x_0.set_y_axis((-1), 2)
        ...
        self.connect((self.blocks_char_to_float_1, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.blocks_delay_0, 0), (self.blocks_threshold_ff_0, 0))
...
def main(top_block_cls=ask_propio, options=None):
