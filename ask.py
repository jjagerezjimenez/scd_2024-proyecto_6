...
class ask(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.constelacion = constelacion = digital.constellation_calcdist([0,1], [0, 1],
        1, 1, digital.constellation.NO_NORMALIZATION).base()
        self.constelacion.set_npwr(1.0)
        ...
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(constelacion, .01, (-.1), .1)
        ...
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.qtgui_time_sink_x_0_0, 2))
        ...
        self.connect((self.digital_constellation_receiver_cb_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.digital_constellation_receiver_cb_0, 4), (self.blocks_complex_to_real_0_0, 0))
